...
const styles = StyleSheet.create({
  ...
  optionsContainer: {
    position: "absolute",
    top: 60, // Điều chỉnh vị trí theo thiết kế của bạn
    right: 10, // Đảm bảo optionsContainer không bị che khuất
    backgroundColor: "#FFFFFF",
    borderWidth: 1,
    borderColor: "#DDD",
    borderRadius: 8,
    ...
    shadowRadius: 8,
    elevation: 5,
    zIndex: 10000, // Đảm bảo zIndex cao hơn các thành phần khác
  },
