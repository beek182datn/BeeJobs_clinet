...
export namespace ExpoRouter {
  type StaticRoutes = `/` | `/(insidescreens)/AppliedJobByTime` | `/(insidescreens)/ChatRoom` | `/(insidescreens)/CompanyDetail` | `/(insidescreens)/JobDetail` | `/(outsidescreens)` | `/(outsidescreens)/ChangePassword` | `/(outsidescreens)/CompleteProfileScreen` | `/(outsidescreens)/CompleteProfileScreen1` | `/(outsidescreens)/CompleteProfileScreen2` | `/(outsidescreens)/ForgotPasswordScreen` | `/(outsidescreens)/LoginScreen` | `/(outsidescreens)/OtpVerificationScreen` | `/(outsidescreens)/RegisterScreen` | `/(outsidescreens)/ResetPasswordScreen` | `/(outsidescreens)/VerifyAccount` | `/(tabs)` | `/AppliedJobByTime` | `/AppliedJobs` | `/ChangePassword` | `/ChatRoom` | `/CompanyDetail` | `/CompleteProfileScreen` | `/CompleteProfileScreen1` | `/CompleteProfileScreen2` | `/ForgotPasswordScreen` | `/Home` | `/JobDetail` | `/LoginScreen` | `/Notification` | `/OtpVerificationScreen` | `/Profile` | `/RegisterScreen` | `/ResetPasswordScreen` | `/VerifyAccount` | `/_sitemap`;
