...
<<<<<<< HEAD
  type StaticRoutes = `/` | `/(insidescreens)/AppliedJobByTime` | `/(insidescreens)/ChatRoom` | `/(insidescreens)/CompanyDetail` | `/(insidescreens)/CompanyDetail2` | `/(insidescreens)/CompanyIntroduction` | `/(insidescreens)/HelpCenter` | `/(insidescreens)/JobDetail` | `/(insidescreens)/JobsFollowed` | `/(insidescreens)/PrivacyPolicy` | `/(insidescreens)/TermsOfService` | `/(insidescreens)/ViewCV` | `/(insidescreens)/ViewPdf` | `/(outsidescreens)` | `/(outsidescreens)/AppliedJobs` | `/(outsidescreens)/ChangePassword` | `/(outsidescreens)/CompleteProfileScreen` | `/(outsidescreens)/CompleteProfileScreen1` | `/(outsidescreens)/CompleteProfileScreen2` | `/(outsidescreens)/FollowCompany` | `/(outsidescreens)/ForgotPasswordScreen` | `/(outsidescreens)/LoginScreen` | `/(outsidescreens)/OtpVerificationScreen` | `/(outsidescreens)/RegisterScreen` | `/(outsidescreens)/ResetPasswordScreen` | `/(outsidescreens)/VerifyAccount` | `/(tabs)` | `/AppliedJobByTime` | `/AppliedJobs` | `/ChangePassword` | `/ChatRoom` | `/CompanyDetail` | `/CompanyDetail2` | `/CompanyIntroduction` | `/CompleteProfileScreen` | `/CompleteProfileScreen1` | `/CompleteProfileScreen2` | `/FollowCompany` | `/ForgotPasswordScreen` | `/HelpCenter` | `/Home` | `/JobDetail` | `/JobsFollowed` | `/LoginScreen` | `/Messenger` | `/Notification` | `/OtpVerificationScreen` | `/PrivacyPolicy` | `/Profile` | `/RegisterScreen` | `/ResetPasswordScreen` | `/TermsOfService` | `/VerifyAccount` | `/ViewCV` | `/ViewPdf` | `/_sitemap`;
=======
  type StaticRoutes = `/` | `/(insidescreens)/AppliedJobByTime` | `/(insidescreens)/ChatRoom` | `/(insidescreens)/CompanyDetail` | `/(insidescreens)/CompanyDetail2` | `/(insidescreens)/CompanyIntroduction` | `/(insidescreens)/HelpCenter` | `/(insidescreens)/JobDetail` | `/(insidescreens)/JobsFollowed` | `/(insidescreens)/PrivacyPolicy` | `/(insidescreens)/TermsOfService` | `/(insidescreens)/ViewPdf` | `/(outsidescreens)` | `/(outsidescreens)/AppliedJobs` | `/(outsidescreens)/ChangePassword` | `/(outsidescreens)/CompleteProfileScreen` | `/(outsidescreens)/CompleteProfileScreen1` | `/(outsidescreens)/CompleteProfileScreen2` | `/(outsidescreens)/FollowCompany` | `/(outsidescreens)/ForgotPasswordScreen` | `/(outsidescreens)/LoginScreen` | `/(outsidescreens)/OtpVerificationScreen` | `/(outsidescreens)/RegisterScreen` | `/(outsidescreens)/ResetPasswordScreen` | `/(outsidescreens)/VerifyAccount` | `/(tabs)` | `/AppliedJobByTime` | `/AppliedJobs` | `/ChangePassword` | `/ChatRoom` | `/CompanyDetail` | `/CompanyDetail2` | `/CompanyIntroduction` | `/CompleteProfileScreen` | `/CompleteProfileScreen1` | `/CompleteProfileScreen2` | `/FollowCompany` | `/ForgotPasswordScreen` | `/HelpCenter` | `/Home` | `/JobDetail` | `/JobsFollowed` | `/LoginScreen` | `/Messenger` | `/Notification` | `/OtpVerificationScreen` | `/PrivacyPolicy` | `/Profile` | `/RegisterScreen` | `/ResetPasswordScreen` | `/TermsOfService` | `/VerifyAccount` | `/ViewPdf` | `/_sitemap`;
