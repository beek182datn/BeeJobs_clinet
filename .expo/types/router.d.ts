...
export namespace ExpoRouter {
  type StaticRoutes = `/` | `/(insidescreens)/AppliedJobByTime` | `/(insidescreens)/ChatRoom` | `/(insidescreens)/CompanyDetail` | `/(insidescreens)/CompanyDetail2` | `/(insidescreens)/JobDetail` | `/(insidescreens)/JobsFollowed` | `/(insidescreens)/ViewPdf` | `/(insidescreens)\CompanyIntroduction` | `/(insidescreens)\HelpCenter` | `/(insidescreens)\PrivacyPolicy` | `/(insidescreens)\TermsOfService` | `/(outsidescreens)` | `/(outsidescreens)/AppliedJobs` | `/(outsidescreens)/ChangePassword` | `/(outsidescreens)/CompleteProfileScreen` | `/(outsidescreens)/CompleteProfileScreen1` | `/(outsidescreens)/CompleteProfileScreen2` | `/(outsidescreens)/FollowCompany` | `/(outsidescreens)/ForgotPasswordScreen` | `/(outsidescreens)/LoginScreen` | `/(outsidescreens)/OtpVerificationScreen` | `/(outsidescreens)/RegisterScreen` | `/(outsidescreens)/ResetPasswordScreen` | `/(outsidescreens)/VerifyAccount` | `/(tabs)` | `/..\components\fetch_data\notifi` | `/AppliedJobByTime` | `/AppliedJobs` | `/ChangePassword` | `/ChatRoom` | `/CompanyDetail` | `/CompanyDetail2` | `/CompleteProfileScreen` | `/CompleteProfileScreen1` | `/CompleteProfileScreen2` | `/FollowCompany` | `/ForgotPasswordScreen` | `/Home` | `/JobDetail` | `/JobsFollowed` | `/LoginScreen` | `/Messenger` | `/Notification` | `/OtpVerificationScreen` | `/Profile` | `/RegisterScreen` | `/ResetPasswordScreen` | `/VerifyAccount` | `/ViewPdf` | `/_sitemap`;
