...
export namespace ExpoRouter {
  type StaticRoutes = `/` | `/(homes)` | `/..\components\Model\Model` | `/ForgotPasswordScreen` | `/Home` | `/LoginScreen` | `/OtpVerificationScreen` | `/Profile` | `/RegisterScreen` | `/ResetPasswordScreen` | `/_sitemap`;
