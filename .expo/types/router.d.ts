...
export namespace ExpoRouter {
  type StaticRoutes = `/` | `/(insidescreens)/JobDetail` | `/(outsidescreens)` | `/(outsidescreens)/CompleteProfileScreen` | `/(outsidescreens)/CompleteProfileScreen1` | `/(outsidescreens)/CompleteProfileScreen2` | `/(outsidescreens)/ForgotPasswordScreen` | `/(outsidescreens)/LoginScreen` | `/(outsidescreens)/OtpVerificationScreen` | `/(outsidescreens)/RegisterScreen` | `/(outsidescreens)/ResetPasswordScreen` | `/(outsidescreens)/VerifyAccount` | `/(tabs)` | `/CV_Profile` | `/CompleteProfileScreen` | `/CompleteProfileScreen1` | `/CompleteProfileScreen2` | `/ForgotPasswordScreen` | `/Home` | `/JobDetail` | `/LoginScreen` | `/Notification` | `/OtpVerificationScreen` | `/Profile` | `/RegisterScreen` | `/ResetPasswordScreen` | `/VerifyAccount` | `/_sitemap`;
