...
export namespace ExpoRouter {
  type StaticRoutes = `/` | `/(homes)` | `/(homes)\CV_Profile` | `/(homes)\Notification` | `/CompleteProfileScreen` | `/CompleteProfileScreen1` | `/ForgotPasswordScreen` | `/Home` | `/LoginScreen` | `/OtpVerificationScreen` | `/Profile` | `/RegisterScreen` | `/ResetPasswordScreen` | `/_sitemap`;
