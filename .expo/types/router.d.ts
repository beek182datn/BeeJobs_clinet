...
<<<<<<< HEAD
  type StaticRoutes = `/` | `/(insidescreens)/AppliedJobByTime` | `/(insidescreens)/ChatRoom` | `/(insidescreens)/CompanyDetail` | `/(insidescreens)/CompanyDetail2` | `/(insidescreens)/JobDetail` | `/(outsidescreens)` | `/(outsidescreens)/AppliedJobs` | `/(outsidescreens)/ChangePassword` | `/(outsidescreens)/CompleteProfileScreen` | `/(outsidescreens)/CompleteProfileScreen1` | `/(outsidescreens)/CompleteProfileScreen2` | `/(outsidescreens)/FollowCompany` | `/(outsidescreens)/ForgotPasswordScreen` | `/(outsidescreens)/LoginScreen` | `/(outsidescreens)/OtpVerificationScreen` | `/(outsidescreens)/RegisterScreen` | `/(outsidescreens)/ResetPasswordScreen` | `/(outsidescreens)/VerifyAccount` | `/(tabs)` | `/AppliedJobByTime` | `/AppliedJobs` | `/ChangePassword` | `/ChatRoom` | `/CompanyDetail` | `/CompanyDetail2` | `/CompleteProfileScreen` | `/CompleteProfileScreen1` | `/CompleteProfileScreen2` | `/FollowCompany` | `/ForgotPasswordScreen` | `/Home` | `/JobDetail` | `/LoginScreen` | `/Messenger` | `/Notification` | `/OtpVerificationScreen` | `/Profile` | `/RegisterScreen` | `/ResetPasswordScreen` | `/VerifyAccount` | `/_sitemap`;
=======
  type StaticRoutes = `/` | `/(insidescreens)/AppliedJobByTime` | `/(insidescreens)/ChatRoom` | `/(insidescreens)/CompanyDetail` | `/(insidescreens)/CompanyDetail2` | `/(insidescreens)/JobDetail` | `/(outsidescreens)` | `/(outsidescreens)/ChangePassword` | `/(outsidescreens)/CompleteProfileScreen` | `/(outsidescreens)/CompleteProfileScreen1` | `/(outsidescreens)/CompleteProfileScreen2` | `/(outsidescreens)/FollowCompany` | `/(outsidescreens)/ForgotPasswordScreen` | `/(outsidescreens)/LoginScreen` | `/(outsidescreens)/OtpVerificationScreen` | `/(outsidescreens)/RegisterScreen` | `/(outsidescreens)/ResetPasswordScreen` | `/(outsidescreens)/VerifyAccount` | `/(outsidescreens)\AppliedJobs` | `/(tabs)` | `/(tabs)\Messenger` | `/AppliedJobByTime` | `/AppliedJobs` | `/ChangePassword` | `/ChatRoom` | `/CompanyDetail` | `/CompanyDetail2` | `/CompleteProfileScreen` | `/CompleteProfileScreen1` | `/CompleteProfileScreen2` | `/FollowCompany` | `/ForgotPasswordScreen` | `/Home` | `/JobDetail` | `/LoginScreen` | `/Notification` | `/OtpVerificationScreen` | `/Profile` | `/RegisterScreen` | `/ResetPasswordScreen` | `/VerifyAccount` | `/_sitemap`;
>>>>>>> c7bc0167297db8228131b8c5f76291127ba49866
